                ...
                <div class="col-lg-12">
                    <div class="card m-t-35">
                        ...
                        <div class="card-block">
                            ...
                            {/if}
                            <form class="form-horizontal" method="post" action="{$BASE_URL}index.php/admin/category/edit_sub?c_id={$c_id}">
                                <fieldset>
                                    <div class="form-group row">
                                        <div class="col-lg-10 push-lg-1">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="sub_cat_cats" value="{$cat_details[0].sub_categories}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
