      ...
      {*<div class="col-xs-12 col-sm-12 col-md-4 animate-dropdown top-cart-row">*}
        ...
        {*<div class="col-xs-12 col-sm-12 col-md-4">*}
          {*<ul class="account">*}
            ...
            {*<li><a href="{$BASE_URL}registry/couple/action/settings">Hi, {$user_details[0].name|default: ''}*}
              {*</a></li>*}
              {*{else}*}
              {*<li><a href="{$BASE_URL}registry/couple/action/settings">Hi, {$user_details[0].groom_first_name|default: ''}*}
                {*</a></li>*}
              {*{/if}*}
            {*{else}*}
