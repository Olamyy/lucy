 <!-- ============================================== TOP MENU ============================================== -->
    <div class="top-bar animate-dropdown">
        <div class="container">
            ...
            <!-- /.cnt-cart -->
            <div class="offer-text">{$PROMO|default:'Promo'}</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                    <!-- ============================================================= LOGO ============================================================= -->
                    <div class="logo"> <a href="{$BASE_URL}"> <img src="{$BASE_URL}{$SMARTY_VIEW_FOLDER}/front-theme/assets/images/logo.png" alt="logo"> </a> </div>
                    <!-- /.logo -->
                    <!-- ============================================================= LOGO : END ============================================================= --> </div>
                <!-- /.logo-holder -->
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="dropdown"> <a href="{$BASE_URL}index.php/Wedding" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">Wedding</a>
                                            ...
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-xs-12 col-menu">
                                                        <ul class="links">
                                                            <li><a href="{$BASE_URL}index.php/Registry/find">Find A Registry</a></li>
                                                            <li><a href="{$BASE_URL}index.php/Registry/create">Create A Registry</a></li>
                                                            <li><a href="{$BASE_URL}index.php/Registry/manage">Manage Registries</a></li>
                                                            <li><a href="{$BASE_URL}index.php/Registry/help">Walk Through</a></li>
                                                            <li><a href="{$BASE_URL}index.php/Registry/whyus">Why Lucy Registry?</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{$BASE_URL}{$SMARTY_VIEW_FOLDER}/front-theme/assets/images/banners/wedding1.jpg" alt=""> </div>
                                                    <!-- /.yamm-content -->
                                                </div>
                                            </div>
                                        </li>
