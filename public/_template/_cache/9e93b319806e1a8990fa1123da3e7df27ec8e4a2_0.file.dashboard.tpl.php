<?php /* Smarty version 3.1.24, created on 2017-01-15 19:08:34
         compiled from "public/_template/admin/dashboard.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:887682327587bbaa28627d9_97966101%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '887682327587bbaa28627d9_97966101',
  'variables' => 
  array (
    'BASE_URL' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_587bbaa2920150_74318038',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_587bbaa2920150_74318038')) {
function content_587bbaa2920150_74318038 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '887682327587bbaa28627d9_97966101';
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <ul class="Browser_stats_ul">
                                        <li><span><img alt="google" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/chrome.png"/>Google Crome</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="firebox" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/firefox.png">Firefox</span><span
                                                    class="float-xs-right text-danger">5%<i
                                                        class="fa fa-level-down"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="safari" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/safari2.png">Safari</span><span
                                                    class="float-xs-right text-mint">10%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="opera" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/opera.png">Opera</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="ie" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/Ie.png">IE</span><span
                                                    class="float-xs-right text-danger">15%<i
                                                        class="fa fa-level-down"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="mobile" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/mobile1.png">Mobile</span><span
                                                    class="float-xs-right text-mint">32%<i
                                                        class="fa fa-level-up"></i></span>
                                            <hr/>
                                        </li>
                                        <li><span><img alt="others" src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/others.png">Others</span><span
                                                    class="float-xs-right text-mint">32%<i
...
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/images.jpg" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/images3.jpg" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/images2.jpg" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-2 col-lg-3 col-xl-2">
                                                    <img src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/admin/assets/img/images4.jpg" class="rounded-circle"
                                                         alt="image not found">
                                                </div>
                                                <div class="col-xs-10 col-lg-9 col-xl-10">
