<?php /* Smarty version 3.1.24, created on 2017-06-08 04:40:14
         compiled from "/var/www/html/lucy/public/_template/front/registry/couple/dashboard/couplesmalldetails.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:20796484765938c71e5a68c7_97029757%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20796484765938c71e5a68c7_97029757',
  'variables' => 
  array (
    'complete_details' => 0,
    'user_details' => 0,
  ...
  'version' => '3.1.24',
  'unifunc' => 'content_5938c71e5f5403_65683142',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5938c71e5f5403_65683142')) {
function content_5938c71e5f5403_65683142 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '20796484765938c71e5a68c7_97029757';
?>
<div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
    <div id="advertisement" class="advertisement">
        <div class="item">
                <?php if ((($tmp = @$_smarty_tpl->tpl_vars['complete_details']->value)===null||$tmp==='' ? '' : $tmp) && $_smarty_tpl->tpl_vars['user_details']->value[0]['regType'] == 'wedding') {?>
                    <?php
...
/front/assets/images/dashboardcouple.png" alt="Image">
 ...
 & <?php echo $_smarty_tpl->tpl_vars['user']->value['bride_first_name'];?>
                        ...
                        <div>
                            <h5 style="margin-top: 10px;"><?php if (!$_smarty_tpl->tpl_vars['user']->value['event_date']) {?>Date coming Soon<?php } else {
ob_start();
...
?>
                <?php } else { ?>
                  <div class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['BASE_URL']->value;
echo $_smarty_tpl->tpl_vars['SMARTY_VIEW_FOLDER']->value;?>
/front/assets/images/person.png" alt="Image">
                            <br>
                    <?php
$_from = $_smarty_tpl->tpl_vars['complete_details']->value;
if (!is_array($_from) && !is_object($_from)) {
...
$foreach_user_Sav = $_smarty_tpl->tpl_vars['user'];
?>
                        <bautton class="btn btn-primary" style="background-color: #FF8F00; font-weight: 300; margin-top: 5px; font-size: large;"><?php echo $_smarty_tpl->tpl_vars['user']->value['name'];?>
 </bautton>
                        <div>
                            <h5 style="margin-top: 10px;"><?php if (!$_smarty_tpl->tpl_vars['user']->value['event_date']) {?>Date coming Soon<?php } else {
ob_start();
