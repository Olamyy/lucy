...
<ul id="slide-out" class="side-nav">
    ...
    <li>
        <ul class="tabs">
            <li class="tab col s3"><a class="active" href="index-slider.html#sidebar1">Social</a></li>
            <li class="tab col s3"><a href="index-slider.html#sidebar2">Chat</a></li>
        </ul>
    </li>
    <li id="sidebar1" class="p-20">
        <div class="twitter">
            ...
            <div class="tweet">
                <h3>@Codnauts</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod <a href="index-slider.html#">#tempor</a>.</p>
            </div>
            <div class="tweet">
                <h3>@Codnauts</h3>
                <p>Excepteur sint occaecat cupidatat non proident, sunt in <a href="index-slider.html#">#voluptate</a> culpa qui officia deserunt mollit anim.</p>
            </div>
            <div class="tweet">
                <h3>@Codnauts</h3>
                <p>At vero eos et accusamus et iusto odio <a href="index-slider.html#">#dignissimos</a> <a href="index-slider.html#">#ducimus</a> qui blanditiis praesentium.</p>
            </div>
        </div>
        <div class="facebook">
